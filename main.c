...
void test(){
    ...
    //add data via key
    add_entry(table,TABLE_SIZE,"key1",KEY_SIZE,"data1",DATA_SIZE,&cmp);
    add_entry(table,TABLE_SIZE,"key2",KEY_SIZE,"data2",DATA_SIZE,&cmp);
    add_entry(table,TABLE_SIZE,"key3",KEY_SIZE,"data3",DATA_SIZE,&cmp);
    add_entry(table,TABLE_SIZE,"key4",KEY_SIZE,"data4",DATA_SIZE,&cmp);
    add_entry(table,TABLE_SIZE,"key5",KEY_SIZE,"data5",DATA_SIZE,&cmp);
